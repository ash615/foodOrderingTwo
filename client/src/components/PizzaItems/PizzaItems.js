            ...
            <div className="container1">
                ...
                <main className="main">
                    ...
                    <div className="imgContainer">
                        <img className="img" src="F:/BOARDINFINITYMERNSTACK/CapstoneProjects/food-ordering-portal-master/food-ordering-portal-master/client/src/pizza1.jpg" alt={data.name} />
                    </div>
                </main>
                <footer>
